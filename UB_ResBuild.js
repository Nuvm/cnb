...
var currentVersion = "ResBuild 1.5.7";
var userPosGive;
var plA;
...
function main(data){
  ...
  var cmd = ['!ping','!fresdj','!rcs','!helprcs','!blacklist','!call','!adv','!advertising','!spam','!mehspam','!genre2','!theme2','!rules2','!cmd','!disable','!uploaders','!ships','!credits','!randomevent','!donvoo','!makenightcore','!join','!version','!enable derpstaff','!subscribe','!noobscript','!pokemon','!natvoo','!define'];
  var cmds = ['!fresdj','!genre2','!theme2','!rules2','!rcs','!helprcs','!adv','!spam','!mehspam','!resdj','!pokemon','!spot','!flirt'];
  if (commandWait === true){
